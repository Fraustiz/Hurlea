...
let browsingTimestamp = Math.floor(Date.now() / 1000), iframeDur = 0, iframeCur = 0, iframePau = false, logo = "https://i.imgur.com/HNP2V4l.png", play = "https://i.imgur.com/oMQ0rcy.png", pause = "https://i.imgur.com/f2ZJkCS.png";
...
presence.on("UpdateData", async () => {
    ...
    if (pathname.startsWith("/hurlea_lecture.php")) {
        ...
        [, presenceData.endTimestamp] = presence.getTimestamps(Math.floor(iframeCur), Math.floor(iframeDur));
        ...
        presenceData.details = "Explore le site";
